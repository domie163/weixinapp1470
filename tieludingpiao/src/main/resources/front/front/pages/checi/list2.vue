	...
	<view class="cu-bar bg-white search" :style="[{top:CustomBar + 'px'}]">
        ...
        <view class="action">
            ...
            <button
                    ...
                    v-if="isAuth('checi','新增')" @click="onAddTap()" class="uniui-add">新增</button>
		</view>
	</view>
...
<script>
	export default {
		...
		async onShow() {
            ...
            this.categoryList = checiTypes.data.list
				...
				let params = {
                    ...
                    yonghuId:this.userId,//查询自己的
							...
							if (this.categoryName != 0) {
                                params.checiTypes = this.categoryName
                            }
