    ...
    <view @tap="onDetailTap('news',item.id)" v-for="(item,index) in newsList" :key="index" class="list-item"
        ...
        <view class="listBox recommend">
                ...
                <view class="title"
                    ...
                    <text
                            :style='{"padding":"0 20rpx 0 0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"var(--publicSubColor)","color":"rgba(0, 0, 0, 1)","textAlign":"right","borderRadius":"0 20rpx 0 0","borderWidth":"0","width":"45%","lineHeight":"80rpx","fontSize":"28rpx","borderStyle":"solid"}'
                            @tap="onPageTap('checi')">查看更多
                    </text>
                </view>
        <view class="list-box style6"
              :style='{"padding":"20rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
            <view v-if="checiList.length > 0"
                  @tap="onDetailTap('checi',checiList[0].id)" class="box box1"
                  :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 0 20rpx 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"280rpx"}'>
                <div
                        ...
                        class="title hide1">{{checiList[0].checiName}}
                </div>
                <image
                        :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx 20rpx 140rpx 140rpx","borderWidth":"20rpx","width":"100%","borderStyle":"solid","height":"100%"}'
                        class="list-item-image" mode="aspectFill"
                        :src="baseUrl+checiList[0].checiPhoto">
                </image>
            </view>
            <view class="list-item">
                <view class="list-item-body"
                      :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 2% 20rpx 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"48%","borderStyle":"solid","height":"auto"}'>
                    <view v-if="checiList.length > 1"
                          @tap="onDetailTap('checi',checiList[1].id)" class="box box2"
                          :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 0 20rpx","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"300rpx"}'>
                        <div
                                :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                                class="title hide1">{{checiList[1].checiName}}
                        </div>
                        <image
                                :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx 20rpx 140rpx 140rpx","borderWidth":"20rpx","width":"100%","borderStyle":"solid","height":"100%"}'
                                class="list-item-image" mode="aspectFill"
                                :src="baseUrl+checiList[1].checiPhoto">
                        </image>
                    </view>
                    <view v-if="checiList.length > 2"
                          @tap="onDetailTap('checi',checiList[2].id)" class="box box3"
                          :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"300rpx"}'>
                        <div
                                :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                                class="title hide1">{{checiList[2].checiName}}
                        </div>
                        <image
                                :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx 20rpx 140rpx 140rpx","borderWidth":"20rpx","width":"100%","borderStyle":"solid","height":"100%"}'
                                class="list-item-image" mode="aspectFill"
                                :src="baseUrl+checiList[2].checiPhoto">
                        </image>
                    </view>
                </view>
                <view class="list-item-body"
                      :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 0 20rpx 2%","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"48%","borderStyle":"solid","height":"auto"}'>
                    <view v-if="checiList.length > 3"
                          @tap="onDetailTap('checi',checiList[3].id)" class="box box4"
                          :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 0 20rpx","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"300rpx"}'>
                        <div
                                :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                                class="title hide1">{{checiList[3].checiName}}
                        </div>
                        <image
                                :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx 20rpx 140rpx 140rpx","borderWidth":"20rpx","width":"100%","borderStyle":"solid","height":"100%"}'
                                class="list-item-image" mode="aspectFill"
                                :src="baseUrl+checiList[3].checiPhoto">
                        </image>
                    </view>
                    <view v-if="checiList.length > 4"
                          @tap="onDetailTap('checi',checiList[4].id)" class="box box5"
                          :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"300rpx"}'>
                        <div
                                :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                                class="title hide1">{{checiList[4].checiName}}
                        </div>
                        <image
                                :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx 20rpx 140rpx 140rpx","borderWidth":"20rpx","width":"100%","borderStyle":"solid","height":"100%"}'
                                class="list-item-image" mode="aspectFill"
                                :src="baseUrl+checiList[4].checiPhoto">
                        </image>
                    </view>
                </view>
            </view>
            <view v-if="checiList.length > 5"
                  @tap="onDetailTap('checi',checiList[5].id)" class="box box6"
                  :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"300rpx"}'>
                <div
                        :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                        class="title hide1">{{checiList[5].checiName}}
                </div>
                <image
                        :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx 20rpx 140rpx 140rpx","borderWidth":"20rpx","width":"100%","borderStyle":"solid","height":"100%"}'
                        class="list-item-image" mode="aspectFill"
                        :src="baseUrl+checiList[5].checiPhoto">
                </image>
            </view>
        </view>
...
<script>
    ...
    export default {
        ...
        async onShow() {
            ...
            let checi = await this.$api.requestCondition('checi','gexingtuijian',val);

            this.checiList = checi.data.list
            this.checiList.forEach(function(item, index) {
                if(item.checiContent != null && item.checiContent != "" && item.checiContent != "null"){
                    item.checiContent =item.checiContent.replace(/<img [^>]*src=['"]([^'"]+)[^>]*>/gi,"");//替换图片
                }
            });
