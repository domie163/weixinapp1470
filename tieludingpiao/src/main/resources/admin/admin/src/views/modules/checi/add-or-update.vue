        ...
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.checiPhoto" label="火车照片" prop="checiPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.checiPhoto?$base.url+ruleForm.checiPhoto:''"
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.checiTime"  class="input" label="出发时间" prop="checiTime">
                        <el-date-picker
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.checiContent"  label="经停站、到达时间详情" prop="checiContent">
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.checiContent = _this.ruleForm.checiContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.checiContent = this.ruleForm.checiContent.replaceAll(this.$base.url,"");
                        this.$http({
